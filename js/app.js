...
var acc = document.getElementsByClassName("education-section__accordion");
...
(function () {
  //sidenav
  let sidenav_links = document.getElementsByClassName(
  ...
  //name
  document.getElementById("sidebar__profile-name").textContent = userInfo.name;
  ...
  let aboutcards = document.getElementsByClassName(
    "about-section__cards--text"
  );
  ...
  let service_cards_headings = document.getElementsByClassName(
    "service-sec__card__heading"
  );

  let service_card_text = document.getElementsByClassName(
    "service-sec__card__text"
  );
  ...
  //transparent image
  let transparent_img_text = document.getElementsByClassName(
    "transparent-img__paraOne"
  );
  let transparent_img_text2 = document.getElementsByClassName(
    "transparent-img__paraTwo"
  );
  ...
  let accordions = document.getElementsByClassName(
    "education-section__accordion"
  );
  for (accordion in accordions) {
    accordions[accordion].textContent = userInfo.accordionTitle[accordion];
  }

  let acc_data = document.getElementsByClassName("education-section__para");
  for (accordion_para in acc_data) {
    acc_data[accordion_para].textContent =
      userInfo.accordion_body[accordion_para];
  }

  let acc_lists = document.getElementsByClassName("education-section__list");
  for (acc_list in acc_lists) {
    acc_lists[acc_list].textContent = userInfo.accordion_list;
  }

  //timeline
  let timelineheadings = document.getElementsByClassName(
    "experience-section__timeline__heading"
  );
  let timelinecontent = document.getElementsByClassName(
    "experience-section__timeline__para"
  );
  ...
  //work
  let work_navbar_links = document.getElementsByClassName(
    "work-section__navigation__link"
  );
  ...
  //contact
  let details = document.getElementsByClassName("contact-section__details");
...
let progress_bars = document.querySelectorAll(".skills-section__progressBar");
let progress_percentagees = document.querySelectorAll(
  ".skills-section--progressPercentage"
);
